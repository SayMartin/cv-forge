    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        <input
          ...
          required
          className="w-full border border-(--cl-border) rounded-lg px-3 py-2 pr-10 text-sm bg-white text-(--cl-text) focus:outline-none focus:ring-2 focus:ring-(--cl-accent)"
        />
        <button
          type="button"
          onClick={() => setShow((v) => !v)}
